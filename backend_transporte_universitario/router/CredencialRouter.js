...
router.get('/usuario/:id_usuario', verifyToken, obtenerCredencialPorUsuario);

// Crear credencial para usuario (solo admin)
router.post('/', verifyToken, requireRol(['ADMINISTRADOR']), crearCredencial);
...
router.patch('/usuario/:id_usuario/estado', verifyToken, requireRol(['ADMINISTRADOR']), cambiarEstadoCredencial);
